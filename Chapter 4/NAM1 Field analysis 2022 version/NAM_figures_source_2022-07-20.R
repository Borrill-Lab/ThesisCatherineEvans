...
#setwd("U:/Field senescence re-analysis/scripts")
...
Wide_data <- read_csv("Field_results_NAM_2022_wide_DDAH_2023-08-23.csv",
                      col_types = cols("NAMA1"= col_factor(),
                                       "NAMB1"= col_factor())
)
setwd("..")
...
variable_list_field <- c("EE_REL",
                   ...
                   "`Peduncle_senescence.2022-07-12`",
                   "Height")
variable_list_unquote_field<- c("EE_REL",
                                                 "Leaf_TT70",
                                                 "AUC_Leaf_Sen",
                                                 "Dur_Leaf_Sen", 
                                                 "Ear_TT70",
