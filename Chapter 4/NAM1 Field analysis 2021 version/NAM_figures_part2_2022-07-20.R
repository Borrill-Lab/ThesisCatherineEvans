...
linear_models_factorial <- list(
  ...
  Yield = lm(Yield ~ NAMA1 * NAMB1, data = Wide_data_no_control),
  EE = lm(EE ~ NAMA1 * NAMB1, data = Wide_data_no_control),
  Protein = lm(Protein ~ NAMA1 * NAMB1, data = Wide_data_no_control)
)
...
save_panel_svg(combined, paste("Combined_boxplots_2021_", variable_list_truncated_field[1], sep = "_"), gene = "NAM1",
...
save_panel_svg(combined, paste("Combined_boxplots_2021_", variable_list_truncated_field[5], sep = "_"), gene = "NAM1",
               n_panel_cols = 2, n_panel_rows = 2, ratio = 1)
...
save_panel_svg(combined, paste("Combined_boxplots_2021_", variable_list_truncated_field[10], sep = "_"), gene = "NAM1",
               n_panel_cols = 2, n_panel_rows = 2, ratio = 1)
