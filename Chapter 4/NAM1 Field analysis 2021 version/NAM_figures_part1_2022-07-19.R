...
for(i in 1:length(variable_list)){
  plot2 <- 
    ...
    theme_minimal() +
    labs(fill = str_wrap(variable_labels_field[variable_list[i]], width = 20))
  print(plot2)
  save_small_svg(plot2, "tile_plot_2021", variable_list[i])
}
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
save_panel_svg(ggarrange(Averages_plot_leaf, Averages_plot_ear, ncol = 1), "Averages_plot_2021", "NAM1",
