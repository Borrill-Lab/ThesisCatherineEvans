...
library(readxl)
KASP_NAM2_Greenhouse_calls_set1 <- read_excel("C:/Users/evansc/OneDrive - Norwich BioScience Institutes/NAM-2 TILLING/2022-09-14 NAM2 greenhouse/2022-10-05 KASP NAM2 greenhouse/2022-10-06 _KASP_NAM2_Greenhouse_calls.xlsx",
                                              sheet = "set1")
...
KASP_NAM2_Greenhouse_calls_set2 <- read_excel("C:/Users/evansc/OneDrive - Norwich BioScience Institutes/NAM-2 TILLING/2022-09-14 NAM2 greenhouse/2022-10-05 KASP NAM2 greenhouse/2022-10-06 _KASP_NAM2_Greenhouse_calls.xlsx",
                                              sheet = "set2")
...
latin_square <- design.lsd(treat_set1, seed = 20220915) #auto reps = n_treat = 8

View(t(latin_square$sketch))

# Bonus_RCBD_set1 <- design.rcbd(treat_set1,r=2, seed = 20220915)
# View(t(Bonus_RCBD_set1$sketch))
#I didn't know how to do this so I manually edited in Excel until it balanced as much as possible
Blocks_9_10_bonus_2022_10_21 <- read_csv("C:/Users/evansc/OneDrive - Norwich BioScience Institutes/NAM-2 TILLING/2022-09-14 NAM2 greenhouse/Blocks_9_10_bonus_2022-10-21.csv",
                                         col_types = c("dfff"))

Latin_square_plus_set1 <- full_join(latin_square$book, Blocks_9_10_bonus_2022_10_21) %>%
  group_by(treat_set1) %>%
...
latin_square <- design.lsd(treat_set2, seed = 20221024) #auto reps = n_treat = 8

View(t(latin_square$sketch))

Bonus_RCBD_set2 <- design.rcbd(treat_set2,r=2, seed = 20221024)
View(t(Bonus_RCBD_set2$sketch))
#I didn't know how to do this so I manually edited in Excel until it balanced as much as possible
Blocks_9_10_bonus_set2 <- read_csv("C:/Users/evansc/OneDrive - Norwich BioScience Institutes/NAM-2 TILLING/2022-09-14 NAM2 greenhouse/Blocks_9_10_bonus_set2_2022-10-21.csv",
                                         col_types = c("dfff"))

Latin_square_plus_set2 <- full_join(latin_square$book, Blocks_9_10_bonus_set2) %>%
  group_by(treat_set2) %>%
  mutate(Rep = sample(n_reps, n_reps, replace = FALSE)) %>%
