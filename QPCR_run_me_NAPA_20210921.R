...
#Save some documents
write.csv(exclude_report, file = paste("qPCR_", experiment_title,"exclusions_", today_date, ".csv", sep=""))
write.csv(qPCR_v4, file = paste("qPCR_", experiment_title,"replicate_CT_",today_date, ".csv", sep=""))
write.csv(analysis, file = paste("qPCR_", experiment_title,"analysis_",today_date, ".csv", sep=""))
